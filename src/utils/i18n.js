...
const translations = {
  fr: {
    ...
    waitlist_empty: '✅ Plus personne sur la liste d\'attente.',

    // Calendar
    calendar_title: '📅 Sessions à venir',
    calendar_empty: 'Aucune session planifiée.',
    calendar_status_recruitment: '🟢 Recrutement',
    calendar_status_preparation: '🟡 En préparation',
    calendar_status_ready: '🔵 Prêt',
    calendar_status_done: '✅ Terminé',
    ...
    error_missing_permissions: '❌ Permissions insuffisantes.',
  ...
  en: {
    ...
    waitlist_empty: '✅ No one on the waitlist.',

    // Calendar
    calendar_title: '📅 Upcoming Sessions',
    calendar_empty: 'No sessions scheduled.',
    calendar_status_recruitment: '🟢 Recruitment',
    calendar_status_preparation: '🟡 In preparation',
    calendar_status_ready: '🔵 Ready',
    ...
    error_missing_permissions: '❌ Insufficient permissions.',
